...
var MsgTest = /** @class */ (function (_super) {
    ...
    MsgTest.prototype.validateBasic = function () { };
    __decorate([
        Field.Defined()
...
describe("Test std tx", function () {
    stdTx_1.registerCodec(ts_amino_1.Amino.globalCodec);
    it("std sign doc should generate corrent sign doc", function () {
        address_1.useBech32Config(bech32Config_1.defaultBech32Config("cosmos"), function () {
            var signDoc = new stdTx_1.StdSignDoc(ts_amino_1.Amino.globalCodec, 1, "test", new stdTx_1.StdFee([new coin_1.Coin("test", new int_1.Int(10))], 1000), "test", [
                new MsgTest(buffer_1.Buffer.from("5e8f356453a096748ef5966fbe26d65079db30a8", "hex"))
            ], 10);
            assert_1.default.strictEqual(signDoc.getSignBytes().toString(), "{\"account_number\":\"1\",\"chain_id\":\"test\",\"fee\":{\"amount\":[{\"amount\":\"10\",\"denom\":\"test\"}],\"gas\":\"1000\"},\"memo\":\"test\",\"msgs\":[{\"type\":\"test/MsgTest\",\"value\":{\"address\":\"cosmos1t68n2ezn5zt8frh4jehmufkk2puakv9glapyz4\"}}],\"sequence\":\"10\"}");
        });
    });
});
