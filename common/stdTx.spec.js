...
var Field = ts_amino_1.Amino.Field,
  Concrete = ts_amino_1.Amino.Concrete,
...
var MsgTest = /** @class */ (function(_super) {
  ...
  function MsgTest(address) {
    ...
    _this.address = new address_1.AccAddress(address, "cosmos");
    return _this;
  }
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  MsgTest.prototype.validateBasic = function() {};
  __decorate([Field.Defined()], MsgTest.prototype, "address", void 0);
  MsgTest = __decorate([Concrete("test/MsgTest"), DefineStruct()], MsgTest);
  return MsgTest;
})(tx_1.Msg);
describe("Test std tx", function() {
  ...
  it("std sign doc should generate corrent sign doc", function() {
    var signDoc = new stdTx_1.StdSignDoc(
      ts_amino_1.Amino.globalCodec,
      1,
      "test",
      new stdTx_1.StdFee([new coin_1.Coin("test", new int_1.Int(10))], 1000),
      "test",
      [
        new MsgTest(
          buffer_1.Buffer.from(
            "5e8f356453a096748ef5966fbe26d65079db30a8",
            "hex"
          )
        )
      ],
