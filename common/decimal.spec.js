  ...
  it("dec should be caculated properly", function() {
    ...
    var _loop_1 = function(test_1) {
      ...
      assert_1.default.strictEqual(
        resAdd.toString(),
        test_1.expAdd.toString(),
        "invalid result of add"
      );
      assert_1.default.strictEqual(
        resSub.toString(),
        test_1.expSub.toString(),
        "invalid result of sub"
      );
      assert_1.default.strictEqual(
        resMul.toString(),
        test_1.expMul.toString(),
        "invalid result of mul"
      );
      assert_1.default.strictEqual(
        resMulTruncate.toString(),
        test_1.expMulTruncate.toString(),
        "invalid result of mul"
      );
      if (test_1.d2.isZero()) {
        assert_1.default.throws(function() {
