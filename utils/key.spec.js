...
describe("Test wallet", function () {
    it("generate key and mnemonic", function () {
        ...
        assert_1.default.strictEqual(mnemonic.split(" ").length, 24, "should generate 24 words by default");
        var recoveredPrivKey = Key.generateWalletFromMnemonic(mnemonic);
        assert_1.default.strictEqual(recoveredPrivKey.toString(), privKey.toString());
        assert_1.default.strictEqual(recoveredPrivKey.toPubKey().toString(), privKey.toPubKey().toString());
        assert_1.default.strictEqual(recoveredPrivKey
            .toPubKey()
            .toAddress()
    ...
    it("recover key from mnemonic", function () {
        ...
        assert_1.default.strictEqual(privKey
            .toPubKey()
            .toAddress()
