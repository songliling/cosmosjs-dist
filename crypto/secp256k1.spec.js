...
describe("Test secp256k1", function() {
  ...
  it("secp256k1 should generate correct signature", function() {
    var privKey = new secp256k1_1.PrivKeySecp256k1(
      new Uint8Array([
        110,
        52,
        11,
    ...
    assert_1.default.strictEqual(
      buffer_1.Buffer.from(pubKey.toBytes()).toString("hex"),
    ...
    assert_1.default.strictEqual(
      buffer_1.Buffer.from(signature).toString("hex"),
    ...
    var verified = pubKey.verify(new Uint8Array([1, 2, 3]), signature);
