...
var ResultBroadcastTx = /** @class */ (function() {
  ...
  ResultBroadcastTx.fromJSON = function(obj, mode) {
    ...
    return new ResultBroadcastTx(
      mode,
      result.code,
      buffer_1.Buffer.from(result.data, "hex"),
      result.log,
      buffer_1.Buffer.from(result.hash, "hex")
    );
  };
...
var ResultBroadcastTxCommit = /** @class */ (function() {
  ...
  ResultBroadcastTxCommit.fromJSON = function(obj) {
    ...
    return new ResultBroadcastTxCommit(
      ...
      buffer_1.Buffer.from(result.hash, "hex"),
      big_integer_1.default(result.height)
    );
  };
...
var ResponseCheckTx = /** @class */ (function() {
  ...
  ResponseCheckTx.fromJSON = function(obj) {
    ...
    return new ResponseCheckTx(
      obj.code,
      obj.data
        ? buffer_1.Buffer.from(obj.data, "base64")
        : buffer_1.Buffer.from([]),
      obj.log,
      obj.info,
      big_integer_1.default(obj.gas_wanted),
      big_integer_1.default(obj.gas_used),
      tags,
      obj.codespace
    );
  };
