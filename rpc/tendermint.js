  ...
  TendermintRPC.prototype.status = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.instance.get("/status")];
          case 1:
            result = _a.sent();
  ...
  TendermintRPC.prototype.abciInfo = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.instance.get("/abci_info")];
          case 1:
            result = _a.sent();
            if (result.data.error) {
              error = result.data.error;
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            height = opts
              ? big_integer_1.default(opts.height)
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.instance.get("/broadcast_tx_" + mode, {
                params: {
                  tx: "0x" + hex
                }
              })
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              tx_1.ResultBroadcastTx.fromJSON(result.data, mode)
            ];
        }
      });
    });
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.instance.get("/broadcast_tx_commit", {
                params: {
                  tx: "0x" + hex
                }
              })
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              tx_1.ResultBroadcastTxCommit.fromJSON(result.data)
            ];
        }
      });
    });
