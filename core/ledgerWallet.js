...
var LedgerWalletProvider = /** @class */ (function() {
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 7];
          case 1:
            return [4 /*yield*/, TransportWebUSB.create()];
          case 2:
            transport = _b.sent();
            return [3 /*break*/, 8];
          case 3:
            return [4 /*yield*/, TransportU2F.create()];
          case 4:
            transport = _b.sent();
            return [3 /*break*/, 8];
          case 5:
            return [4 /*yield*/, TransportHID.create()];
          case 6:
            transport = _b.sent();
            return [3 /*break*/, 8];
          case 7:
          ...
          case 10:
            ...
            this.key = {
              address: address_1.AccAddress.fromBech32(
  ...
  LedgerWalletProvider.prototype.sign = function(
    context,
    bech32Address,
    message
  ) {
