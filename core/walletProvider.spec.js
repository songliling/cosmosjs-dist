...
describe("Test local wallet provider", function () {
    it("local wallet provider should generate correct priv key", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    localWalletProvider = new walletProvider_1.LocalWalletProvider("anger river nuclear pig enlist fish demand dress library obtain concert nasty wolf episode ring bargain rely off vibrant iron cram witness extra enforce", 0, 0, function (array) {
                ...
                case 2:
                    ...
                    assert_1.default.strictEqual(new crypto_2.PubKeySecp256k1(key.pubKey).toAddress().toBech32("cosmos"), "cosmos1t68n2ezn5zt8frh4jehmufkk2puakv9glapyz4");
                    assert_1.default.strictEqual(key.bech32Address, "cosmos1t68n2ezn5zt8frh4jehmufkk2puakv9glapyz4");
                    return [2 /*return*/];
            }
        });
    }); });
