...
function queryAccount(bech32Config, rpcInstance, account) {
    var _this = this;
    return address_1.useBech32ConfigPromise(bech32Config, function () { return __awaiter(_this, void 0, void 0, function () {
        var accAddress, result, r, response, value;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accAddress = typeof account === "string"
                        ? address_1.AccAddress.fromBech32(account)
                        : new address_1.AccAddress(account);
