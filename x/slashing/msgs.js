...
var MsgUnjail = /** @class */ (function(_super) {
  ...
  function MsgUnjail(validatorAddr, bech32PrefixAccAddr) {
  ...
  MsgUnjail.prototype.validateBasic = function() {};
  MsgUnjail.prototype.getSigners = function() {
    return [
      new address_1.AccAddress(
        this.validatorAddr.toBytes(),
  ...
  MsgUnjail = __decorate([DefineStruct()], MsgUnjail);
  return MsgUnjail;
})(tx_1.Msg);
